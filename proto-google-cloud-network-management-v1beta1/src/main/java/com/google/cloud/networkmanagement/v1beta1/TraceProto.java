  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ment.v1beta1\032\034google/api/annotations.proto\"\221\001\n"
          + "\005Trace\022K\n\r"
          + "endpoint_info\030\001 \001(\01324.go"
          + "ogle.cloud.networkmanagement.v1beta1.EndpointInfo\022;\n"
          ...
          + "ogle.cloud.networkmanagement.v1beta1.Step.State\022\023\n"
          + "\013causes_drop\030\003 \001(\010\022\022\n\n"
          + "project_id\030\004 \001(\t\022H\n"
          + "\010instance\030\005 \001(\01324.google.clou"
          + "d.networkmanagement.v1beta1.InstanceInfoH\000\022H\n"
          + "\010firewall\030\006"
          + " \001(\01324.google.cloud.networkmanagement.v1beta1.FirewallInfoH\000\022B\n"
          + "\005route\030\007"
          + " \001(\01321.google.cloud.networkmanagement.v1beta1.RouteInfoH\000\022H\n"
          + "\010endpoint\030\010 \001"
          + "(\01324.google.cloud.networkmanagement.v1beta1.EndpointInfoH\000\022U\n"
          + "\017forwarding_rule\030\t "
          + "\001(\0132:.google.cloud.networkmanagement.v1beta1.ForwardingRuleInfoH\000\022M\n"
          + "\013vpn_gateway\030\n"
          + " \001(\01326.google.cloud.networkmanagement.v1beta1.VpnGatewayInfoH\000\022K\n\n"
          + "vpn_tunnel\030\013"
          + " \001(\01325.google.cloud.networkmanagement.v1beta1.VpnTunnelInfoH\000\022F\n"
          ...
          + "\004drop\030\017"
          + " \001(\01320.google.cloud.networkmanagement.v1beta1.DropInfoH\000\022Q\n\r"
          + "load_balancer\030\020 \001"
          + "(\01328.google.cloud.networkmanagement.v1beta1.LoadBalancerInfoH\000\022F\n"
          + "\007network\030\021 \001(\0132"
          + "3.google.cloud.networkmanagement.v1beta1.NetworkInfoH\000\022K\n\n"
          + "gke_master\030\022 \001(\01325.goo"
          + "gle.cloud.networkmanagement.v1beta1.GKEMasterInfoH\000\022Z\n"
          + "\022cloud_sql_instance\030\023 \001(\0132"
          + "<.google.cloud.networkmanagement.v1beta1.CloudSQLInstanceInfoH\000\"\270\004\n"
          + "\005State\022\025\n"
          ...
          + "ement.v1beta1.FirewallInfo.FirewallRuleType\"\223\001\n"
          ...
          + "ud.networkmanagement.v1beta1.RouteInfo.RouteType\022T\n\r"
          + "next_hop_type\030\t \001(\0162=.google"
          + ".cloud.networkmanagement.v1beta1.RouteInfo.NextHopType\022\024\n"
          + "\014display_name\030\001 \001(\t\022\013\n"
          ...
          + "instance_tags\030\007 \003(\t\"\211\001\n"
          + "\tRouteType\022\032\n"
          ...
          + ".networkmanagement.v1beta1.LoadBalancerInfo.LoadBalancerType\022\030\n"
          ...
          + "ud.networkmanagement.v1beta1.LoadBalancerInfo.BackendType\022\023\n"
          ...
          + "\033health_check_firewall_state\030\003 \001(\0162T.google.cloud.networkmanagement.v1b"
          + "eta1.LoadBalancerBackend.HealthCheckFirewallState\022,\n"
          ...
          + ".google.cloud.networkmanagement.v1beta1.VpnTunnelInfo.RoutingType\"[\n"
          ...
          + "\027destination_network_uri\030\007 \001(\t\"\345\001\n"
          + "\013DeliverInfo\022J\n"
          + "\006target\030\001"
          ...
          + "\022CLOUD_SQL_INSTANCE\020\005\"\222\002\n"
          + "\013ForwardInfo\022J\n"
          + "\006target\030\001"
          ...
          + "\022CLOUD_SQL_INSTANCE\020\006\"\347\003\n"
          + "\tAbortInfo\022F\n"
          ...
          + "\022\"\n"
          + "\036MISMATCHED_DESTINATION_NETWORK\020\016\"\237\006\n"
          + "\010DropInfo\022E\n"
          + "\005cause\030\001"
          ...
          + " PRIVATE_GOOGLE_ACCESS_DISALLOWED\020\010\022\027\n"
          ...
          + "TraceProtoP\001ZWgoogle.golang.org/genproto/googleapis/cloud/networkmanagement/v1"
